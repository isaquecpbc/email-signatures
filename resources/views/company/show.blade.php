...
@section('content')
    ...
    <div id="logoShow">
		<div class='col-md-12'>
			<img src="{{ url('storage/assets/images/companies/'.$company->image) }}" class="logoCompany">
			<h2>{{$company->site}}</h2>
		</div>
		<div class='col-md-12'>
		        ...
		        <td style="text-align:left;border-right: 2.5px solid rgba(120, 130, 140, 0.13) !important;">
		            <table id="image" bgcolor="#FFFFFF" align="left" role="presentation" cellspacing="0" cellpadding="0" border="0" width="150" height="150" style="margin:auto;">
		                <tbody>
		                    <tr>
		                        <td>
									<img src="{{ url('assets/images/team/broto.jpg') }}" class="imgEmployee">
		                        </td>                            
		                    </tr>
		                </tbody>
		            </table>
										                ...
										                <tbody>
										                    <tr>
										                        <td width="350" style="text-align:right;width:350px;">
																	<img src="{{ url('storage/assets/images/companies/'.$company->image) }}" style="display:inline-block;" width="auto" height="40" class="logocompany">
										                        </td>                            
										                    </tr>
										                </tbody>
										            </table>
