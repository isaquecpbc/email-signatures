...
@section('content')
    <div id="logoShow" class='row'>
    	<div class='col-md-2'>
			<img src="{{ url('storage/assets/images/employees/'.$employee->image) }}" class="w-75">
		</div>
    	<div class='col-md-10'>
    		<div class='col-md-12'>
    			<h2>{{$employee->name}}</h2>
    ...
    <hr>
    <div id="example">
		<table bgcolor="#FFFFFF" id="Table_mail" style="margin:0 auto 0 auto;width:800px;padding:50px 50px 50px 50px;width:800px;height:340px;" style="display:block;" height="340" border="0" cellpadding="0" cellspacing="0" align="center"><tbody>
		    <tr>
		        <td style="text-align:left;border-right: 2.5px solid rgba(120, 130, 140, 0.13) !important;">
		            <table id="image_employee" bgcolor="#FFFFFF" align="left" role="presentation" cellspacing="0" cellpadding="0" border="0" width="150" height="150" style="margin:auto;">
		                <tbody>
		                    <tr>
		                        <td>
									<img src="{{ url('storage/assets/images/employees/'.$employee->image) }}" style="border-radius:200px;border:1px solid white;padding:0px;width:125px;height:125px;" class="imgEmployee">
		                        </td>                            
		                    </tr>
		                </tbody>
		            </table>
						                ...
						                <tbody>
						                    <tr>
										        ...
										        <td style="text-align:right;">
										            <table id="image_company" bgcolor="#FFFFFF" align="right" role="presentation" cellspacing="0" cellpadding="0" border="0" width="350" height="75" style="margin:auto;padding-top:25px;text-align:right;">
										                <tbody>
										                    <tr>
										                        <td width="350" style="text-align:right;width:350px;">
																	<img src="{{ url('storage/assets/images/companies/'.$employee->company()->first()->image) }}" style="display:inline-block;" width="auto" height="40" class="logocompany">
										                        </td>                            
										                    </tr>
										                </tbody>
										            </table>
